...
public class ConfirmTaskRequest : BaseRequest {
    ...
    public override void Awake()
    {
        ...
        actionCode = ActionCode.ConfirmTask;
        base.Awake();
    }
    ...
    public void SendRequest(int id,TaskState state)
    {
        base.SendRequest(id+","+(int)state);
    }
